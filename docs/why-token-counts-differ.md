...
| 4 | **Pricing assumptions corroborated** | Their independently-maintained pricing table (same GitHub source) confirms **1 credit = $0.01**, **cache-read = 10% of input** for every current model, and **Anthropic cache-write = 125%** — the exact rates in our catalog. |
